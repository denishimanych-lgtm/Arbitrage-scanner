  ...
  module Services
    class SettingsLoader
      ...
      SETTING_TYPES = {
        ...
        enable_funding_alerts: :boolean,
        enable_zscore_alerts: :boolean,
        enable_stablecoin_alerts: :boolean,
        zscore_entry_threshold: :float,
        zscore_stop_threshold: :float,
        zscore_exit_threshold: :float,
        zscore_lookback_days: :integer,
        zscore_min_data_points: :integer,
        funding_min_rate: :float,
        funding_min_spread: :float,
        funding_min_apr: :float,
        stablecoin_alert_threshold: :float,
        curve_stress_threshold: :float,
        enabled_cex: :array,
        enabled_dex: :array,
